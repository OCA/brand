...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:19c4ba24df7afee53062bd88c8b0d42d037f522c0bb9a6eea9d1167c06ddf4f8
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fbrand-lightgray.png?logo=github
    :target: https://github.com/OCA/brand/tree/18.0/sale_order_partner_brand
    :alt: OCA/brand
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/brand-18-0/brand-18-0-sale_order_partner_brand
...
contact record), the "Brand" field on the Sales Order will automatically
be populated with the customer's brand.

Selecting a Customer without a Brand:

If you select a customer who does not have a brand assigned to them, the
"Brand" field on the Sales Order will be automatically cleared (set to
empty/None).

*Changing Customer*:

If you change the customer on an existing Sales Order, the brand on the
SO will update according to the newly selected customer's brand (or be
cleared if the new customer has no brand).

Clearing Customer:

If you clear the "Customer" field on the Sales Order (remove the
selected customer), the "Brand" field on the Sales Order will also be
automatically cleared.

This behavior is triggered by an onchange mechanism on the partner_id
field of the sale.order model.
...
on the Sales Order directly if needed. The onchange mechanism only
...
`feedback <https://github.com/OCA/brand/issues/new?body=module:%20sale_order_partner_brand%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/brand <https://github.com/OCA/brand/tree/18.0/sale_order_partner_brand>`_ project on GitHub.
